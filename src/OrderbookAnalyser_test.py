...
class TestClass(object):
    ...
    def test_one(self):
        ...
        def feedSamples():
            ...
            orderbookAnalyser.update('kraken','ETH/USD',bids=[[100,1000]],asks=[[200,1000]],id=2,timestamp=101)
            orderbookAnalyser.update('kraken','ETH/BTC',bids=[[0.03,1000]],asks=[[0.04,1000]],id=3,timestamp=102)
